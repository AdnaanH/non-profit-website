...
const Hero = () => {
    return ( 
        <div className="min-h-[500px] w-full bg-no-repeat bg-[#3cb4ac] bg-cover bg-center md:px-12 px-4 flex justify-start items-center" style={{backgroundImage: `url('/hero.jpg')`}}>
